...
export default function IndustrialDoorList({ dealId, editMode, dealReference }) {
    ...
    function handleGenerateQuoteEmail() {
        if (doors.length === 0) {
        ...
        doors.forEach((door, index) => {
            ...
            const dimensiones = door.width_available && door.height_available
...
`;
        ...
        try {
            ...
            alert('Correo HTML copiado al portapapeles. Puedes pegarlo en tu cliente de correo.\n\nTambién se abrirá tu cliente de correo predeterminado.');
        } catch (err) {
